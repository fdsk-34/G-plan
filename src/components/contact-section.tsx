    ...
    <div id="contact" className="min-h-screen bg-white">
      <main>
        ...
        <section className="relative bg-gradient-to-b from-gray-50 to-white pb-16 sm:pb-20 pt-24 sm:pt-32">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-5xl text-center">
              ...
              <h2 className="mb-4 sm:mb-6 text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold tracking-tight text-gray-900 px-4">{t("pages.contact.title")}</h2>
            ...
            <section className="py-12 sm:py-20">
              <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                <div className="mb-4 sm:mb-6 flex items-center">
                  <h3 className="text-xl sm:text-2xl font-bold text-gray-900">{t("pages.contact.mapTitle")}</h3>
                  <div className="ml-2 sm:ml-4 h-px flex-1 bg-gradient-to-r from-orange-400 to-transparent"></div>
                </div>
                <div className="overflow-hidden rounded-lg border border-gray-200 shadow-sm">
                  <iframe
                    src={`https://www.google.com/maps/embed/v1/place?key=AIzaSyBFw0Qbyq9zTFTd-tUY6dZWTgaQzuU17R8&q=경기도+김포시+김포한강10로+133번길+107&zoom=17${lang === "en" ? "&hl=en" : ""}`}
                    width="100%"
                    height="300"
        ...
        <section className="bg-white py-12 sm:py-20">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="mb-4 sm:mb-6 flex items-center">
              <h3 className="text-xl sm:text-2xl font-bold text-gray-900">{t("pages.contact.addressTitle")}</h3>
              <div className="ml-2 sm:ml-4 h-px flex-1 bg-gradient-to-r from-orange-400 to-transparent"></div>
            </div>
        ...
        <section className="bg-white py-12 sm:py-20">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="mb-4 sm:mb-6 flex items-center">
              <h3 className="text-xl sm:text-2xl font-bold text-gray-900">{t("pages.contact.transportationTitle")}</h3>
              <div className="ml-2 sm:ml-4 h-px flex-1 bg-gradient-to-r from-orange-400 to-transparent"></div>
            </div>
            <div className="space-y-4">
              <div className="rounded-lg border border-gray-200 bg-gray-50 p-4 sm:p-6 md:p-8">
                <div className="flex items-start gap-3 sm:gap-4">
                  ...
                  <div>
                    <h4 className="mb-2 text-base sm:text-lg font-semibold text-gray-900">{t("pages.contact.subway")}</h4>
