...
export function InquirySection() {
  const { t } = useT()
  return (
    <div id="inquiry" className="min-h-screen bg-white">
      <main>
        {/* Hero Section */}
        <section className="relative pt-24 sm:pt-32 pb-16 sm:pb-20 bg-gradient-to-b from-gray-50 to-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-5xl mx-auto text-center">
              ...
              <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-gray-900 mb-4 sm:mb-6 tracking-tight px-4">{t("pages.inquiry.title")}</h2>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-10 sm:mb-16">
                <h3 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-4">{t("pages.inquiry.methodsTitle")}</h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
                ...
                <div className="group relative p-6 sm:p-10 md:p-12 rounded-2xl sm:rounded-3xl bg-white border border-gray-200 hover:border-gray-900 transition-all duration-300 hover:shadow-xl">
                  <div className="text-center">
                    ...
                    <h4 className="text-xl sm:text-2xl font-bold text-gray-900 mb-3 sm:mb-4">{t("pages.inquiry.phone")}</h4>
                    <a
                ...
                <div className="group relative p-6 sm:p-10 md:p-12 rounded-2xl sm:rounded-3xl bg-white border border-gray-200 hover:border-gray-900 transition-all duration-300 hover:shadow-xl">
                  <div className="text-center">
                    ...
                    <h4 className="text-xl sm:text-2xl font-bold text-gray-900 mb-3 sm:mb-4">{t("pages.inquiry.email")}</h4>
                    <a
