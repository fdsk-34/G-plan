...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: `${t("navigation.inquiry", locale)} | 지플랜(GPLAN)`,
    description: t("pages.inquiry.subtitle", locale) as string,
    alternates: {
      canonical: "/inquiry",
    },
  }
...
export default async function InquiryPage() {
  const locale = await getServerLocale()
  const subtitle = t("pages.inquiry.subtitle", locale) as string
        ...
        <section className="relative pt-24 sm:pt-32 pb-16 sm:pb-20 bg-gradient-to-b from-gray-50 to-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-5xl mx-auto text-center">
              ...
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-gray-900 mb-4 sm:mb-6 tracking-tight px-4">{t("pages.inquiry.title", locale)}</h1>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-10 sm:mb-16">
                <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-4">{t("pages.inquiry.methodsTitle", locale)}</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
                ...
                <div className="group relative p-6 sm:p-10 md:p-12 rounded-2xl sm:rounded-3xl bg-white border border-gray-200 hover:border-gray-900 transition-all duration-300 hover:shadow-xl">
                  <div className="text-center">
                    ...
                    <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-3 sm:mb-4">{t("pages.inquiry.phone", locale)}</h3>
                    <a
                    ...
                    <p className="text-xs sm:text-sm md:text-base text-gray-600 mt-2 sm:mt-3 md:mt-4">{t("pages.inquiry.phoneHours", locale)}</p>
                  </div>
                </div>
                ...
                <div className="group relative p-6 sm:p-10 md:p-12 rounded-2xl sm:rounded-3xl bg-white border border-gray-200 hover:border-gray-900 transition-all duration-300 hover:shadow-xl">
                  <div className="text-center">
                    ...
                    <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-3 sm:mb-4">{t("pages.inquiry.email", locale)}</h3>
                    <a
                    ...
                    <p className="text-xs sm:text-sm md:text-base text-gray-600 mt-2 sm:mt-3 md:mt-4">{t("pages.inquiry.emailHours", locale)}</p>
                  </div>
                </div>
              </div>
            </div>
