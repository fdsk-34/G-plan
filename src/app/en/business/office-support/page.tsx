...
export const metadata: Metadata = generatePageMetadata({
  title: "Office Support Services - GPLAN",
  description: "GPLAN provides comprehensive office support services including HR/welfare administration, accounting support, and RPA-based productivity improvement.",
  path: '/en/business/office-support',
  keywords: ['GPLAN', 'Office support', 'HR', 'Accounting', 'RPA', 'Productivity'],
  locale: 'en',
})

export default async function EnOfficeSupportPage() {
  const locale = 'en'
